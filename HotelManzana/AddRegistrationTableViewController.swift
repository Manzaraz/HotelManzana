...
class AddRegistrationTableViewController: UITableViewController, SelectRoomTypeTableViewControllerDelegate {
    ...
    @IBOutlet var chargesNumbersOfNightsDetailLabel: UILabel!
    ...
    func updateChargesSection() {
        ...
        chargesNumbersOfNightsDetailLabel.text  = "\(checkInDatePicker.date.formatted(date: .abbreviated, time: .omitted))"
